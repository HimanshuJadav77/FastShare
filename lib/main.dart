...
void main() {
  ...
  appProviderContainer.read(transferHistoryProvider.notifier).load();
  runApp(UncontrolledProviderScope(container: appProviderContainer, child: const FastShareApp()));
}
